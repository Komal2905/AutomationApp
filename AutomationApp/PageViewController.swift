//
//  WalkThruPageViewController.swift
//  AutomationApp
//
...
class PageViewController: UIPageViewController
{
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [self.newColoredViewController("WalkThru1"),
                self.newColoredViewController("WalkThru2"),
                self.newColoredViewController("WalkThru3")]
    }()
