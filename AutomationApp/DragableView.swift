...
class DraggableView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        QuestionLable = UILabel(frame: CGRectMake(0, -30, self.frame.size.width, 100))
        QuestionLable.text = "TPMS Instalation"
        QuestionLable.textAlignment = NSTextAlignment.Center
        QuestionLable.textColor = UIColor.whiteColor()
        QuestionLable.font.fontWithSize(4.0)
        
        
        questionslable = UILabel(frame: CGRectMake(0, -10, self.frame.size.width, 100))
        questionslable.text = "Lets do a One time setup"
        questionslable.numberOfLines = 3
        questionslable.textAlignment = NSTextAlignment.Center
        questionslable.textColor =  UIColor.whiteColor()
        
        
        imageView = UIImageView(frame: CGRectMake(10, 75, self.frame.size.width/4, self.frame.size.width/4))
        imageView.image = UIImage(named: "Showing Video Frames-52-2")
        
        
        
        textView = UITextView(frame: CGRectMake(self.frame.size.width/4 + 10, 75, self.frame.size.width/4, self.frame.size.width/4))
